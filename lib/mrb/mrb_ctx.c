...
ctx_get_error_level(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(ctx->errlvl);
}
...
ctx_get_error_line(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(ctx->errline);
}
...
ctx_get_command_version(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(grn_ctx_get_command_version(ctx));
}
...
ctx_set_command_version(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(command_version);
}
...
ctx_get_output_type(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(grn_ctx_get_output_type(ctx));
}
...
ctx_set_output_type(mrb_state *mrb, mrb_value self)
{
  ...
  return mrb_int_value(output_type);
}

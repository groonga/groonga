...
#define GRN_II_MAX_CHUNK_SMALL                                                 \
  (1 << (GRN_II_W_TOTAL_CHUNK - GRN_II_W_CHUNK - 8))
 ...
 */
#define GRN_II_MAX_CHUNK_MEDIUM                                                \
  (1 << (GRN_II_W_TOTAL_CHUNK - GRN_II_W_CHUNK - 4))
...
grn_rc
grn_ii_update_one(
  grn_ctx *ctx, grn_ii *ii, uint32_t key, grn_ii_updspec *u, grn_hash *h);
grn_rc
grn_ii_delete_one(
  grn_ctx *ctx, grn_ii *ii, uint32_t key, grn_ii_updspec *u, grn_hash *h);
grn_ii_updspec *
...
grn_ii_cursor *
grn_ii_cursor_openv1(grn_ii *ii, uint32_t key);
grn_rc
grn_ii_cursor_openv2(grn_ii_cursor **cursors, int ncursors);

uint32_t
grn_ii_get_array_pseg(grn_ii *ii, uint32_t lseg);
uint32_t
grn_ii_get_buffer_pseg(grn_ii *ii, uint32_t pseg);
uint32_t

...
xxhash_version = (base_dir + "bundled_xxhash_version").read.strip

xxhash_base = "xxhash-#{xxhash_version}"
...
download("https://github.com/Cyan4973/xxHash/archive/v#{xxhash_version}.tar.gz",
         xxhash_base)

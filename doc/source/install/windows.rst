...
packages.groonga.org:
  ...
  * https://packages.groonga.org/windows/groonga/groonga-10.0.7-x86.exe
...
packages.goronga.org:
  ...
  * https://packages.groonga.org/windows/groonga/groonga-10.0.7-x64.exe
...
packages.groonga.org:
  ...
  * https://packages.groonga.org/windows/groonga/groonga-10.0.7-x86.zip
...
packages.groonga.org:
  ...
  * https://packages.groonga.org/windows/groonga/groonga-10.0.7-x64.zip
...
Download zipped source from packages.groonga.org:
  ...
  * https://packages.groonga.org/source/groonga/groonga-10.0.7.zip

Then extract it.

Move to the Groonga's source folder::

  > cd c:\Users\%USERNAME%\Downloads\groonga-10.0.7

Configure by ``cmake``. The following commnad line is for 64-bit
version. To build 32-bit version, use ``-G "Visual Studio 12 2013"``
parameter instead::

  groonga-10.0.7> cmake . -G "Visual Studio 12 2013 Win64" -DCMAKE_INSTALL_PREFIX=C:\Groonga

Build::

  groonga-10.0.7> cmake --build . --config Release

Install::

  groonga-10.0.7> cmake --build . --config Release --target Install

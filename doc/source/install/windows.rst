...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-5.0.9-x86.exe
...
packages.goronga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-5.0.9-x64.exe
...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-5.0.9-x86.zip
...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-5.0.9-x64.zip
...
Download zipped source from packages.groonga.org:
  ...
  * http://packages.groonga.org/source/groonga/groonga-5.0.9.zip

Then extract it.

Move to the Groonga's source folder::

  > cd c:\Users\%USERNAME%\Downloads\groonga-5.0.9

Configure by ``cmake``. The following commnad line is for 64-bit
version. To build 32-bit version, use ``-G "Visual Studio 12 2013"``
parameter instead::

  groonga-5.0.9> cmake . -G "Visual Studio 12 2013 Win64" -DCMAKE_INSTALL_PREFIX=C:\Groonga

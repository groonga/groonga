...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-6.1.2-x86.exe
...
packages.goronga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-6.1.2-x64.exe
...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-6.1.2-x86.zip
...
packages.groonga.org:
  ...
  * http://packages.groonga.org/windows/groonga/groonga-6.1.2-x64.zip
...
Download zipped source from packages.groonga.org:
  ...
  * http://packages.groonga.org/source/groonga/groonga-6.1.2.zip

Then extract it.

Move to the Groonga's source folder::

  > cd c:\Users\%USERNAME%\Downloads\groonga-6.1.2

Configure by ``cmake``. The following commnad line is for 64-bit
version. To build 32-bit version, use ``-G "Visual Studio 12 2013"``
parameter instead::

  groonga-6.1.2> cmake . -G "Visual Studio 12 2013 Win64" -DCMAKE_INSTALL_PREFIX=C:\Groonga

Build::

  groonga-6.1.2> cmake --build . --config Release

Install::

  groonga-6.1.2> cmake --build . --config Release --target Install

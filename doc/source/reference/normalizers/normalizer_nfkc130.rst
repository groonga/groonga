...
Specify option::
  ...
  NormalizerNFKC130("unify_katakana_zu_small_sounds", true)
  ...
  NormalizerNFKC130("unify_kana_prolonged_sound_mark", true)

  NormalizerNFKC130("unify_kana_hyphen", true)

.. versionadded:: 13.0.0

  :ref:`normalizer-nfkc130-unify-katakana-gu-small-sounds` is added.

  :ref:`normalizer-nfkc130-unify-katakana-di-sound` is added.

  :ref:`normalizer-nfkc130-unify-katakana-wo-sound` is added.

  :ref:`normalizer-nfkc130-unify-katakana-zu-small-sounds` is added.

  :ref:`normalizer-nfkc130-unify-katakana-du-sound` is added.

  :ref:`normalizer-nfkc130-unify-katakana-trailing-o` is added.

  :ref:`normalizer-nfkc130-unify-katakana-du-small-sounds` is added.

.. versionadded:: 13.0.1

  :ref:`normalizer-nfkc130-unify-kana-prolonged-sound-mark` is added.

  :ref:`normalizer-nfkc130-unify-kana-hyphen` is added.
...
Here is an example of :ref:`normalizer-nfkc130-unify-katakana-gu-small-sounds` option.
This option enables to normalize "グァグィグェグォ" to "ガギゲゴ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-katakana-gu-small-sounds.log
.. normalize   'NormalizerNFKC130("unify_katakana_gu_small_sounds", true)'   "グァグィグェグォ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-di-sound` option.
This option enables to normalize "ヂ" to "ジ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-di-sound.log
.. normalize   'NormalizerNFKC130("unify_katakana_di_sound", true)'   "ヂ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-wo-sound` option.
This option enables to normalize "ヲ" to "オ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-wo-sound.log
.. normalize   'NormalizerNFKC130("unify_katakana_wo_sound", true)'   "ヲ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-zu-small-sounds` option.
This option enables to normalize "ズァズィズェズォ" to "ザジゼゾ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-zu-small-sounds.log
.. normalize   'NormalizerNFKC130("unify_katakana_zu_small_sounds", true)'   "ズァズィズェズォ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-du-sound` option.
This option enables to normalize "ヅ" to "ズ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-du-sound.log
.. normalize   'NormalizerNFKC130("unify_katakana_du_sound", true)'   "ヅ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-trailing-o` option.
This option enables to normalize "オ" to "ウ" when the vowel in the previous letter is "オ" as below.

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-trailing-o.log
.. normalize   'NormalizerNFKC130("unify_katakana_trailing_o", true)'   "オオコオソオトオノオ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-katakana-du-small-sounds` option.
This option enables to normalize "ヅァヅィヅェヅォ" to "ザジゼゾ".

.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-katakana-du-small-sounds.log
.. normalize   'NormalizerNFKC130("unify_katakana_du_small_sounds", true)'   "ヅァヅィヅェヅォ"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-kana-prolonged-sound-mark` option.
...
.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-kana-prolonged-sound-mark.log
.. normalize   'NormalizerNFKC130("unify_kana_prolonged_sound_mark", true)'   "カーキークーケーコー"   WITH_TYPES

Here is an example of :ref:`normalizer-nfkc130-unify-kana-hyphen` option.
...
.. groonga-command
.. include:: ../../example/reference/normalizers/normalizer-nfkc130-unify-kana-hyphen.log
.. normalize   'NormalizerNFKC130("unify_kana_hyphen", true)'   "カ-キ-ク-ケ-コ-"   WITH_TYPES
...
.. _normalizer-nfkc130-unify-katakana-gu-small-sounds:
...
.. _normalizer-nfkc130-unify-katakana-di-sound:
...
.. _normalizer-nfkc130-unify-katakana-wo-sound:
...
.. _normalizer-nfkc130-unify-katakana-zu-small-sounds:
...
.. _normalizer-nfkc130-unify-katakana-du-sound:
...
.. _normalizer-nfkc130-unify-katakana-trailing-o:
...
.. _normalizer-nfkc130-unify-katakana-du-small-sounds:
...
.. _normalizer-nfkc130-unify-kana-prolonged-sound-mark:
...
.. _normalizer-nfkc130-unify-kana-hyphen:

...
``NormalizerNFKC121`` normalizes text by Unicode NFKC (Normalization Form Compatibility Composition)
for Unicode version 12.1.
...
Specify option::
  ...
  NormalizerNFKC121("unify_katakana", true)

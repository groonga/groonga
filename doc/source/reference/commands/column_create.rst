   ...
   * - ``COMPRESS_FILTER_SHUFFLE``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 000 0000 0000 0000 0000 0000 | 1110 0111   |  0         |
          | 1010 1001 1001 1001 1001 001 | 1110 0111   |  0         |
   ...
   * - ``COMPRESS_FILTER_TRUNCATE_PRECISION_1BYTE``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          | 仮数部(23bit)                 | 指数部(8bit) | 符号(1bit)　|
          |------------------------------|-------------|------------|
          | 0000 0000 0000 0000 0000 010 | 1111 0111   | 0          |
          | 1000 0100 0001 1110 1010 110 | 0000 1000   | 0          |
          | 1010 1001 1001 1001 0001 001 | 0001 1000   | 0          |
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 0000 0000 0000 0000 0000 010 | 1111 0111   | 0          |
          | 0000 0000 0001 1110 1010 110 | 0000 1000   | 0          |
          | 0000 0000 1001 1001 0001 001 | 0001 1000   | 0          |
   ...
   * - ``COMPRESS_FILTER_TRUNCATE_PRECISION_2BYTES``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 0000 0000 0000 0000 0000 010 | 1111 0111   | 0          |
          | 0000 0000 0000 0000 1010 110 | 0000 1000   | 0          |
          | 0000 0000 0000 0000 0001 001 | 0001 1000   | 0          |

...
.. list-table::
   ...
   * - ``COMPRESS_FILTER_SHUFFLE``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 000 0000 0000 0000 0000 0000 | 0111 1110   |  0         |
          | 001 1001 1001 1001 1001 1010 | 0111 1110   |  0         |
   ...
   * - ``COMPRESS_FILTER_BYTE_DELTA``
     - .. versionadded:: 13.0.8
       ...
       一定のペースなので、 ``UInt8`` の ``[1,11,21,31,41]`` のように10ずつ値が増加するようなデータでも良いです。
       ...
       ``Byte 1`` のデータの差分は ``[0x12, 0x01, 0x01, 0x00]`` , ``Byte 2`` のデータの差分は ``[0x45, 0x01, 0x01, 0x01]`` となり、差分の値が小さく、また同じ値が連続するようになります。
   ...
   * - ``COMPRESS_FILTER_TRUNCATE_PRECISION_1BYTE``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          | 仮数部(23bit)                 | 指数部(8bit) | 符号(1bit)　|
          |------------------------------|-------------|------------|
          | 010 0000 0000 0000 0000 0000 | 0111 1111   | 0          |
          | 110 1010 1110 0001 0100 1000 | 1000 0000   | 0          |
          | 001 0001 1001 1001 1001 1010 | 1000 0001   | 0          |
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 010 0000 0000 0000 0000 0000 | 0111 1111   | 0          |
          | 110 1010 1110 0001 0000 0000 | 1000 0000   | 0          |
          | 001 0001 1001 1001 0000 0000 | 1000 0001   | 0          |
   ...
   * - ``COMPRESS_FILTER_TRUNCATE_PRECISION_2BYTES``
     - .. versionadded:: 13.0.8
       ...
       .. code-block::
          ...
          |------------------------------|-------------|------------|
          | 010 0000 0000 0000 0000 0000 | 0111 1111   | 0          |
          | 110 1010 0000 0000 0000 0000 | 1000 0000   | 0          |
          | 001 0001 0000 0000 0000 0000 | 1000 0001   | 0          |

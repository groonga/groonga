...
* [{doc}`/reference/commands/column_create`] Added new flags `COLUMN_FILTER_SHUFFLE` and `COLUMN_FILTER_BYTE_DELTA`.

* [{doc}`/reference/commands/column_create`] Added new flags `COMPRESS_FILTER_TRUNCATE_PRECISION_1BYTE` and `COMPRESS_FILTER_TRUNCATE_PRECISION_2BYTES`.

* Added newly bundling library Blosc.
...
* [{doc}`/reference/commands/status`] Added a new features `"blosc"`.

* [{doc}`/reference/executables/groonga`] Added `blosc` to `--version` output.

* [{doc}`/reference/commands/select`] Added a new argument `--fuzzy_max_distance`.

* [{doc}`/reference/commands/select`] Added a new argument `--fuzzy_max_expansion`.

* [{doc}`/reference/commands/select`] Added a new argument `--fuzzy_max_distance_ratio`

* [{doc}`/reference/commands/select`] Added a new argument `--fuzzy_prefix_length`

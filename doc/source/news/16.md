...
#### Fixed a crash bug when allocation a new segment fails

This issue may occur when updating the index in an environment with insufficient memory or when the limit on the number of memory maps has been reached.
...
Therefore, this issue does not occur in a normal environment.

...
"Independent" means that a drilldown doesn't refer the result of another drilldown by `--drilldowns[${LABEL}].table`.
A drilldown that refers the result of another drilldown is executed after the referred drilldown is finished.

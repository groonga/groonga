...
- [{doc}`/install/ubuntu`] We become able to provide package for Ubuntu again.
  ...
  Because we fail making Groonga package for Ubuntu by problem of build environment for Ubuntu package.

  We fixed problem of build environment for Ubuntu package in 14.0.1. So, we can provide packages for Ubuntu again since this release.

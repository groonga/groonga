...
* [Amazon Linux 2023] Added support for Amazon Linux 2023. [GH-1845][Reported by takoyaki-nyokki and Watson]
  ...
  Because the maintenance costly because of the time of build for package of aarch64 is too time consuming.

  We don't use TokenMecab on Groonga for Amazon Linux 2023.
  Because Amazon Linux 2023 doesn't provide MeCab package.

### Fixes

* Fixed a crash bug when we specify `pgroonga.log_type` on PGroonga for Windows.

...
{doc}`/reference/normalizers/normalizer_nfkc` accepts `version` argument to change used Unicode
...
on {doc}`/reference/normalizers/normalizer_nfkc`. So you can specify Unicode version as `version`.

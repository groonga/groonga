...
#### Fixed a bug that the index build by offline index construction may be broken with 4096 bytes key

Fix: [pgroonga/pgroonga#910](https://github.com/pgroonga/pgroonga/issues/901)

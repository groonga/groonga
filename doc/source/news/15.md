...
We recommend all users who installed groonga-release **before 2025/09/24** to
upgrade to the latest package as following step, regardless of distribution
version. If you installed groonga-release on or **after 2025/09/24**, no
action is required.

...
These were not work.
Because the hyphen characters were not properly treated as symbols to be removed.
In other words, hyphen characters were not removed In this case.

This release fixes this issue.
So, hyphen characters are properly removed from the normalized text as below.

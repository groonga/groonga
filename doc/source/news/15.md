...
If you installed an older `groonga-release` before, remove it once and reinstall the latest package so your system drops the old key:
...
After reinstallation, `groonga-release` contains only the new key:

...
#### [{doc}`/reference/tokenizers/token_language_model_knn`] Added support for progress log
...
#### Fixed a bug that check_max is overflowed with 4096 bytes key

[GH-901](https://github.com/pgroonga/pgroonga/issues/901)

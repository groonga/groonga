...
#### Fixed wide ranging typos across documentation

Corrected typos through a series of PRs, each addressing words beginning with
specific letter ranges (e.g., "A–C", "D–F" etc.).

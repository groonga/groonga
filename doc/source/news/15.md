...
These combination didn't work as expected because the hyphen characters were not properly treated as symbols to be removed.
...
the flag was incorrectly removed. This affected `TABLE_HASH_KEY` tables.

This bug caused truncated table to lose their ability to store more than 4GiB of total key data,

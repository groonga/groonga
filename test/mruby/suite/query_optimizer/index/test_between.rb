...
[0]
  ...
  args[2]:         <\"roonga\">
  args[3]:         <#<table:hash (nil) key:ShortText value:(nil) size:1 columns:[] extractors:(nil) normalizers:(nil) default_tokenizer:(nil) token_filters:(nil) keys:[\"max_distance\"] subrec:none>>
  expr:            <0..4>
[1]
  op:              <call>
  logical_op:      <and>

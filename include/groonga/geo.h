 ...
 * \param index The index column used for searching. The type must be \ref
 *              GRN_DB_TOKYO_GEO_POINT or \ref GRN_DB_WGS84_GEO_POINT.
 * \param top_left_point The top left point of the target rectangle. The type
